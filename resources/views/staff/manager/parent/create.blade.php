                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            ...
                            <!-- form start -->
                            <form
                                action="{{ isset($parent) ? route('parent.update', $parent->parentId) : route('parent.store') }}"
                                method="POST">
                                @csrf
                                @if (isset($parent))
                                    @method('PUT')
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="fullName" class="form-control" id="fullName"
                                            ...
                                            value="{{ isset($parent) ? $parent->fullName : old('fullName') }}">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label for="exampleInputPassword1"
                                            style="display: {{ isset($parent) ? 'none' : '' }}">Password</label>
                                        <input type="password" name="password" class="form-control"
                                            id="exampleInputPassword1" placeholder="Password"
                                            style="display: {{ isset($parent) ? 'none' : '' }}">
                                    </div>
                                    <div class="form-group">
                                        <div class="form-check">
                                            <input class="form-check-input" @checked(isset($parent) && $parent->isActive == 1) value="1"
                                                type="radio" name="isActive">
                                            <label class="form-check-label">Active</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" value="0" @checked(isset($parent) && $parent->isActive == 0)
                                                type="radio" name="isActive">
                                ...
                                <div class="card-footer">
                                    <button type="submit"
                                        class="btn btn-primary">{{ isset($parent) ? 'Update' : 'Submit' }}</button>
                                </div>
                            </form>
                        </div>
                        <!-- /.card -->
